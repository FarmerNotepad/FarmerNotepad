...
public class MainActivity extends AppCompatActivity implements RecyclerViewAdapterMain.OnNoteListener{
    ...
    private ArrayList<Object> allNotesList = new ArrayList<>();
    private ArrayList<TextNoteEntry> textNotes = new ArrayList<>();
    ...
    private void initRecyclerView(){
        ...
        RecyclerViewAdapterMain adapter = new RecyclerViewAdapterMain( allNotesList,textNotes, this);
    ...
    private void clearRecyclerView(){
        if(allNotesList != null && textNotes != null) {
            allNotesList.clear();
            textNotes.clear();
        }
    }
    ...
    public void onNoteClick(int position) {
        ...
        int mNoteID = textNotes.get(position).getNoteID();
